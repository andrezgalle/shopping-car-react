...
export async function action({request}){
  ...
  const resultado = Object.fromEntries(datos)
...
const Login = () => {
  ...
  return (
    <div className=' p-4 flex-col w-full md:h-screen flex items-center md:flex-row md:px-10'>
        ...
        <Form method="post"  className='flex flex-col bg-white p-12 md:w-1/3 md:h-1/1 mb-10 rounded-xl'>
            <input className='p-2 border-b-2 mb-6' name="nombre" type="text" id='nombre' placeholder='Nombre Completo'/>

            <select id="ciudad" name="ciudad" className=' text-gray-400 p-2 border-b-2 mb-6'>
            ...
            <input className='p-2 border-b-2 mb-6' name="correo" type="email" id='correo' placeholder='Correo Electronico'/>
